var util = require('util'),
	...
	log.info("Extracast - transcoder path: "+FFMPEG_BIN_PATH);
...
function Transcoder(source) {
	...
	Transcoder.prototype._exec = function(a) {
		...
		//if seek option .. move options before -i for faster seeking
		var si = a.indexOf('-ss');
		if(si > -1){
			a.move(si,0);
			a.move(si+1,1);
		...
		FFMPEG_BIN_PATH = process.env.FFMPEG_BIN_PATH || 'ffmpeg';
